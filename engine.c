...
int existe_jogada_valida(char jogador){
    ...
    if(jogador == 'C'){
        ...
        for(i = 0; i < 10; i++){
            for(j = 0; j < 10; j++){
                if(tabuleiro[i][j] == baixo_dama || tabuleiro[i][j] == baixo_normal){
                    if(tabuleiro[i][j] == baixo_dama){
                        if(i + 1 <= 9 && j + 1 <= 9 && tabuleiro[i + 1][j + 1] == casa_vazia){
                        return 1;
                        }
                        else if(((i + 1 < 10) && (j - 1 > -1)) && tabuleiro[i + 1][j - 1] == casa_vazia){
                            return 1;
                        }
                        else if((i - 1 > -1 && j + 1 < 10) && tabuleiro[i - 1][j + 1] == casa_vazia){
                            return 1;
                        }
                        else if((i - 1 > -1 && j - 1 > -1) && tabuleiro[i - 1][j - 1] == casa_vazia){
                            return 1;
                        }
                    }
                    else{
                        if((i + 1 < 10 && j + 1 < 10) && tabuleiro[i - 1][j + 1] == casa_vazia){
                            return 1;
                        }
                        else if(((i + 1 < 10) && (j - 1 > -1)) && tabuleiro[i - 1][j - 1] == casa_vazia){
                            return 1;
